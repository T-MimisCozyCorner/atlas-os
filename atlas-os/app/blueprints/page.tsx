...
const categories = [
  ...
  },
  {
    ...
    items: [
      "ChatGPT Prompt Pack",
      "365-Day Caption Bank",
      "AI Wall Art Pack",
      "Cozy Commerce Instagram Kit",
    ...
    <Shell>
      <div className="mb-8">
        ...
        <p className="mt-2 text-slate-400">
          Start every product from a reusable AI blueprint instead of a blank
          page.
        </p>
      </div>
      ...
      <div className="mt-10 rounded-2xl border border-slate-800 bg-slate-950 p-6">
        ...
        <ul className="list-disc space-y-2 pl-6 text-slate-300">
          ...
          <li>One-click product creation</li>
          <li>Publishing Profiles</li>
          <li>Opportunity Vault</li>
          <li>Export Center</li>
          <li>Automatic PDF generation</li>
          <li>ZIP package export</li>
          <li>Payhip publishing</li>
        </ul>
      </div>
