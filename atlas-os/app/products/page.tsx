  ...
  return (
    <Shell>
      <div className="flex items-start justify-between gap-4">
        ...
        <Link href="/products/new" className="btn-primary mt-3 whitespace-nowrap">+ New Product</Link>
      </div>
      ...
      <div className="card overflow-hidden p-0">
        <table className="w-full">
          <thead className="bg-slate-950 text-left text-atlasTeal">
            <tr><th className="p-4">Product</th><th className="p-4">Business</th><th className="p-4">Status</th><th className="p-4">Price</th><th className="p-4">Next Step</th><th className="p-4">Action</th></tr>
          </thead>
          <tbody>
            ...
            {!products?.length && <tr><td className="p-6 text-slate-400" colSpan={6}>No products yet. Click “New Product” to create your first real database record.</td></tr>}
          </tbody>
        </table>
      </div>
    </Shell>
